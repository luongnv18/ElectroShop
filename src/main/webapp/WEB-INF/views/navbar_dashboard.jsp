                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link ${param.activesanpham}" href="/ElectroShop/dashboard"><i class="fa fa-fw fa-user-circle"></i>Sản phẩm <span class="badge badge-success"></span></a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link ${param.activehoadon}" href="/ElectroShop/dashboard/hoadon"><i class="fa fa-shopping-cart"></i>Hóa đơn</a>
                            </li>
                            <li class="nav-item">
